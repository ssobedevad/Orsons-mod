...
{
    public class CursedEssence : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.noGravity = true;
            banner = npc.type;
            bannerItem = mod.ItemType("CursedEssenceBanner");
        ...
        public override void AI()
        {
            ...
            int DustID = Dust.NewDust(npc.position, npc.width, npc.height, 107, 0f, 0f, 0, default(Color), 1f);
        ...
        {
            Item.NewItem(npc.getRect(), ItemID.CursedFlame, Main.rand.Next(2, 4));
        }
