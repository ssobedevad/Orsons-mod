...
namespace OrsonsMod.Projectiles.Friendly.Summon.Minions
{
    public class BeeHive : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                player.ClearBuff(mod.BuffType("BeeHive"));

            }
            if (!player.HasBuff(mod.BuffType("BeeHive")))
            {
            ...
            { Projectile.NewProjectile(projectile.Center, Vector2.Zero, ProjectileID.Bee, projectile.damage, projectile.knockBack, projectile.owner); shootCD = 60; }
